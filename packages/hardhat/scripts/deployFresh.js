...
const main = async () => {
  ...
  console.log("\n\n 📡 Deploying Pricing...\n");
  const LithiumPricing = await ethers.getContractFactory("LithiumPricing")
  const lithiumPricing = await upgrades.deployProxy(LithiumPricing, []) // deploy("LithiumPricing",[],{},{},true);
  await lithiumPricing.deployed()
  console.log(`lithium address ${lithiumPricing.address}  ${lithiumPricing.resolvedAddress}`)
  // const ProxyAdmin = await upgrades.admin.getInstance();
  // chalk.cyan(console.log("ProxyAdmin Contract Address",chalk.magenta(ProxyAdmin.address)))
  const lithiumPricingImplementationAddress = lithiumPricing.address // await ProxyAdmin.getProxyImplementation(lithiumPricing.address)
  ...
  console.log(`setting lithium reward addresss`)
